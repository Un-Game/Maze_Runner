...
export default function MapMaker() {
    ...
    return (
        <div className="w-screen h-screen flex items-center justify-center" onMouseDown={() => setMouseActive(true)} onMouseUp={() => setMouseActive(false)}>
            <div className="absolute border border-green-400 w-[1500px] h-[900px] mt-[-100px] bg-white/50">
                ...
                <button className="bg-black m-[50px] text-[20px] py-[10px] px-[15px] rounded-xl" onClick={()=>{console.log(grid)}}>finish</button>
            </div>
        </div>
    )
}